...
function encryptCardData(
    ...
    if (!version) { // Default version if not provided
        version = "4.5.0"; 
    }

    referrer = `https://checkoutshopper-live.adyen.com/checkoutshopper/securedfields/${stripeKey}/${version}/securedFields.html?type=card&d=${btoa(domain)}`;
